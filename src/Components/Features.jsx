  ...
  const features = [
    {
      ...
      description:
        "Access to premium airlines and discounted airfares for your journey.",
    },
    {
      icon: <Hotel className="h-8 w-8 mb-2 text-primary" />,
      title: "Luxury Accommodations",
      description:
        "Hand-picked hotels and resorts for a comfortable and memorable stay.",
    },
    {
    ...
    },
    {
      ...
      title: "Guided Tours",
      description:
        "Expert local guides to enhance your travel experience and knowledge.",
    },
    {
      icon: <Headphones className="h-8 w-8 mb-2 text-primary" />,
      title: "24/7 Customer Support",
      description:
        "Round-the-clock assistance for any queries or emergencies during your trip.",
    },
    {
